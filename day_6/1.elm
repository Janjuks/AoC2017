...
main =
    puzzleInput
        ...
        |> Array.fromList
        |> (\memBanks -> findRedistributionSteps memBanks Array.empty 0)
        |> toString
        |> text


findRedistributionSteps : Array Int -> Array (Array Int) -> Int -> Int
findRedistributionSteps memBanks previousBankStates steps =
    let
    ...
    in
        if checkBankStateRegistered previousBankStates redistributed then
            ...
            findRedistributionSteps redistributed (Array.push redistributed previousBankStates) (steps + 1)
